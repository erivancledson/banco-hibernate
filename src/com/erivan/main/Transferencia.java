...
import com.erivan.modelo.Conta;

public class Transferencia {

	public static void main(String[] args) {
		
		EntityManagerFactory emf = Persistence.createEntityManagerFactory("bancoHibernate");
		EntityManager em = emf.createEntityManager();
		
		Scanner entrada = new Scanner(System.in);
		//ver se a conta está cadastrada
		Conta conta1 = em.find(Conta.class, 1L);
		if(conta1 == null) {
			//se a conta for nula, cria ela
	    ...
	    System.out.println("Saldo da conta 1: " + conta1.getSaldo() + ". Saldo da conta 2: " + conta2.getSaldo());
          //fecha conexão
	   em.close();
	   ...
	   if(conta1.getSaldo() > 0) {
		   //se o saldo for maior que zero ele commita
		   em.getTransaction().commit();
		   System.out.println("Transferência realizada com sucesso!");
	   }else {
		   //se não ele faz um rollback
